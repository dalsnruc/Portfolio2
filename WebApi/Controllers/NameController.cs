...
public class NameController : BaseController
{
    ...
    [HttpGet("paged", Name = nameof(GetNamesPaged))]
    public IActionResult GetNamesPaged(int page = 0, int pageSize = 2)
    {
        try
        {
            ...
            .GetNames(user.Id, page, pageSize)
